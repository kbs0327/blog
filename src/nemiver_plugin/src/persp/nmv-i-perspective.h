...
public:
    ...
    virtual Gtk::Widget& get_terminal_box ()= 0;
    virtual Gtk::Widget& get_call_stack_box ()= 0;

    /// \returns the body of the perspective.
    virtual Gtk::Widget* get_body () = 0;
    virtual Gtk::Widget& get_source_view_widget2 () = 0;
  //  virtual Gtk::Widget& get_progressbar_widget () = 0;
    ...
    virtual bool is_breakpoint_set_at_line (const UString &a_file_path,
                                    int a_linenum,
                                    bool &a_enabled) = 0;

    virtual void toggle_breakpoint (const UString &a_file_path,
                           int a_linenum) = 0;
